...
- Follow the printed messages to explore the data. 
  ...
  - If you choose the former one, you could explore different plots like follows. If you choose the latter one, you will see a list of apps with developers and stars. Choose the app id will give you the downloading url for each app. 
